...
# Create a local operation and verify Gate9 live snapshot UI is protected by auth.
...
assert_text_scroll 'Backend متصل، يلزم تسجيل دخول المورد' auth-attempt
...
echo SIGNED_GATE9_RUNTIME_PASS | tee "$E/result.txt"
