...
assert_text_scroll 'بوابة المورد — Gate 11' account-gate
assert_text_scroll 'المستحقات الحالية — محلي' account-local-finance
assert_text_scroll 'تسجيل الدخول مطلوب للمزامنة' account-auth
...
echo SIGNED_GATE11_RUNTIME_PASS | tee "$E/result.txt"
