...
data class FxSnapshotEntity(
    ...
    @ColumnInfo(defaultValue = "NULL") val sarNewYer: Double? = null,
    @ColumnInfo(defaultValue = "NULL") val sarOldYer: Double? = null,
    @ColumnInfo(defaultValue = "'SELL'") val approvedRateType: String = "SELL",
    @ColumnInfo(defaultValue = "NULL") val sourceBatchId: String? = null,
    @ColumnInfo(defaultValue = "NULL") val sourcePublishedAt: Long? = null,
    @ColumnInfo(defaultValue = "NULL") val fetchedAt: Long? = null,
    @ColumnInfo(defaultValue = "''") val primarySource: String = "",
    @ColumnInfo(defaultValue = "''") val primarySourceUrl: String = "",
    @ColumnInfo(defaultValue = "''") val comparisonSource: String = "",
    @ColumnInfo(defaultValue = "NULL") val maxVariancePercent: Double? = null,
    @ColumnInfo(defaultValue = "''") val approvalOverrideReason: String = ""
)
...
data class InvoiceGeographicCostEntity(
    ...
    val notes: String = "",
    val recordedBy: Long,
    val recordedAt: Long = com.fush.erp.domain.TrustedTimeService.now()
)
