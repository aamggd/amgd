...
/**
 * Installs the users/RBAC security schema without assuming the final global Room version.
 * Legacy MFA columns/table are retained only for backward-compatible Room migrations; MFA is disabled in v107.
