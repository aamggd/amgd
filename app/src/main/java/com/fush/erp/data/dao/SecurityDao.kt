...
interface SecurityDao {
    ...
    @Query("DELETE FROM roles WHERE code = :code")
    suspend fun deleteRole(code: String): Int
    ...
    @Query("DELETE FROM role_permissions WHERE roleCode = :roleCode AND permissionCode IN (:permissionCodes)")
    suspend fun deleteRolePermissions(roleCode: String, permissionCodes: Set<String>): Int
