...
interface ExpenseDao {
    ...
    @Query("SELECT * FROM expense_attachments ORDER BY id")
    suspend fun allAttachments(): List<ExpenseAttachmentEntity>

    @Query("UPDATE expense_attachments SET uri=:uri WHERE id=:id")
