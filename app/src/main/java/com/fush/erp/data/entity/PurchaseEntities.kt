...
data class PurchaseInvoiceEntity(
    ...
    @ColumnInfo(defaultValue = "0.0") val freightOriginal: Double = 0.0,
    @ColumnInfo(defaultValue = "0.0") val customsOriginal: Double = 0.0,
    @ColumnInfo(defaultValue = "0.0") val otherChargesOriginal: Double = 0.0,
...
@Entity(
    ...
    indices = [Index(value = ["returnNo"], unique = true), Index("purchaseInvoiceId"), Index("supplierId"), Index("warehouseId")],
    foreignKeys = [
...
@Entity(
    ...
    indices = [Index("returnId"), Index("purchaseLineId"), Index("itemId"), Index("unitId")],
    foreignKeys = [
